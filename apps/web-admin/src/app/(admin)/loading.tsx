    ...
    <div className="animate-pulse space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="bg-white rounded-2xl p-5 border border-[#E5E5E5]">
            ...
            <div className="h-7 bg-[#E5E5E5] rounded w-2/3 mb-1" />
      ...
      <div className="grid grid-cols-3 gap-5">
        <div className="col-span-2 bg-white rounded-2xl p-6 border border-[#E5E5E5]">
          <div className="h-4 bg-[#E5E5E5] rounded w-32 mb-6" />
          <div className="h-[200px] bg-[#F8F8F8] rounded-xl" />
        </div>
        <div className="bg-white rounded-2xl p-6 border border-[#E5E5E5]">
          <div className="h-4 bg-[#E5E5E5] rounded w-24 mb-6" />
          <div className="space-y-4">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i}>
                <div className="h-3 bg-[#E5E5E5] rounded mb-2" />

          ...
          <div className="space-y-5">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 text-xs text-blue-700">
              <div className="flex items-center gap-2">
                ...
                <span>Todos os dados são verificados junto à Receita Federal para garantir a segurança da plataforma.</span>
              </div>
            </div>
          ...
          <div className="space-y-5">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-xl px-4 py-3 text-xs text-yellow-800">
              <div className="flex items-start gap-2">
                ...
                <span>Os documentos são analisados manualmente pela nossa equipe antes da liberação do cadastro. Aceito: PDF, JPG, PNG (máx. 10 MB cada).</span>
              </div>
            </div>
